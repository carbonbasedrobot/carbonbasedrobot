...
// Azure IoT
#define IOT_CONFIG_IOTHUB_FQDN "cg-iot-hub.azure-devices.net"
#define IOT_CONFIG_DEVICE_ID "brainofthegarden"
#define IOT_CONFIG_DEVICE_KEY "xH9FouDW8TdQT9XmCG4Z4z8/lclHyMo6LdhO9CQaYIs="
